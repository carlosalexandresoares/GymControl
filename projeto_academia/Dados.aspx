<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dados.aspx.cs" Inherits="projeto_academia.Dados" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            &nbsp;&nbsp;&nbsp;
            <asp:Button ID="btbEditar" runat="server" Text="Atualizar Dados" OnClick="btbEditar_Click" CssClass="styled-button2"/>
            &nbsp;&nbsp;&nbsp;
           
            <asp:LinkButton ID="linkGrafico" runat="server" CssClass="linkGrafico" PostBackUrl="grafico.aspx">Grafico</asp:LinkButton>
             
            <asp:LinkButton ID="LinkAtualizar" runat="server" CssClass="linkGrafico" PostBackUrl="atualizar.aspx">Nova mediada</asp:LinkButton>
       ...
       <div class="container">
            <div class="section">
                ...
                <asp:TextBox ID="txtNome" runat="server" OnTextChanged="txtNome_TextChanged"></asp:TextBox><br />
                ...
                <asp:TextBox ID="txtDataNascimento" runat="server" placeholder="dd/mm/aaaa"></asp:TextBox><br />
                ...
                <label for="txtDataInicio">Data de Início na Academia:</label><br />
                <asp:TextBox ID="txtDataInicio" runat="server" placeholder="dd/mm/aaaa"></asp:TextBox><br />
            </div>

          <div class="section-2">
    <h2>Medidas do Corporais</h2>
    ...
    <div class="subsection">
        ...
        <label for="txtAltura">Altura (m):</label><br />
