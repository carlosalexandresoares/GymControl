<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Formulario.aspx.cs" Inherits="projeto_academia.Formulario" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnSubmit" runat="server" Text="Enviar" OnClick="btnSubmit_Click" CssClass="styled-button" />
        <asp:Label ID="lblMensagem" runat="server"></asp:Label>
        <asp:LinkButton ID="linkConta" runat="server" CssClass="linkConta" PostBackUrl="Dados.aspx">Verificar dados enviados</asp:LinkButton>
        <div class="container">
            <div class="section">
