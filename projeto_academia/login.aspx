<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="projeto_academia.login" %>
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        * {
        ...
        .form .btnLogin {
            background-color: #E47317; /* Cor do botão de login */
            color: #fff;
            padding: 12px 20px;
            border: none;
            border-radius: 5px;
...
<body>
    <canvas id="particlesCanvas"></canvas> <!-- Canvas para as partículas -->
    ...
    <div class="container">
        ...
        <form id="form1" runat="server" class="form">
            ...
            <br />
            <asp:LinkButton ID="linkConta" runat="server" CssClass="linkConta" PostBackUrl="cadastro.aspx">Não tenho conta</asp:LinkButton>
